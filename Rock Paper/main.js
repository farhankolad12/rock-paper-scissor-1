...
rulesBtn.addEventListener("click", () => {
  ...
  document.querySelector(".score-container").style.opacity = "0.5";
...
const paperClick = () => {
  ...
  let output = "";
  if (computerChoice[randomNum] == "paper") {
    output += `
    <div class="you-picked">
    <div class="paper-picked">
    <h1>you picked</h1>
    ...
    `;
    console.log("Computer Choices: Paper", "DRAW");
